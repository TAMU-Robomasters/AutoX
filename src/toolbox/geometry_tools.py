# ruff: noqa
# mypy: ignore-errors
# TODO: figure out what we want to keep from this file
...
class BoundingBox(list):
    ...
    def contains(self, point):
        ...
        return (
            self.x_top_left < point.x
            and self.x_bottom_right > point.x
            and self.y_top_left < point.y
            and self.y_bottom_right > point.y
        )
